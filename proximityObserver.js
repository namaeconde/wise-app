...
const startProximityObserver = () => {
  ...
  // TODO: Update Estimote Cloud credentials at:
  // https://cloud.estimote.com/#/apps/add/your-own-app
  const ESTIMOTE_APP_ID = "<#APP_ID#>";
  const ESTIMOTE_APP_TOKEN = "<#APP_TOKEN#>";

  // will trigger when the user is within ~ 5 m of any beacon with tag "Jollibee"
  // you can add tags to your beacons on https://cloud.estimote.com, in Beacon Settings
  const zone1 = new RNEP.ProximityZone(5, "Jollibee"); // TODO: This data will be from Wisdom server to fetch list of stores
  ...
  const zone2 = new RNEP.ProximityZone(5, "Mang Inasal"); // TODO: This data will be from Wisdom server to fetch list of stores
